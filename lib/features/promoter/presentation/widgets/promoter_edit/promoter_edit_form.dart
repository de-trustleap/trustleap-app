...
import 'package:finanzbegleiter/features/promoter/presentation/widgets/promoter_edit/promoter_edit_no_data_view.dart';
import 'package:finanzbegleiter/features/promoter/presentation/widgets/promoter_registration/register_promoter_no_landingpage_view.dart';
                ...
                return BlocBuilder<LandingPageCubit, LandingPageState>(
                  ...
                  builder: (context, landingPageState) {
                    return CardContainer(
                      ...
                      if (promoterState is PromoterLoadingState ||
                      ...
                      } else if (promoterState is PromoterGetFailureState) {
                        return ErrorView(
                            title: localization
                                .landingpage_overview_error_view_title,
                            message: DatabaseFailureMapper.mapFailureMessage(
                        ...
                        return Column(
                            ...
                            children: [
                              ...
                              SelectableText(
                                  localization.edit_promoter_subtitle,
                              ...
                              if (promoterState
                                  is PromoterEditFailureState) ...[
                                const SizedBox(height: 20),
                                FormErrorView(
                                    message:
                                        DatabaseFailureMapper.mapFailureMessage(
                                            promoterState.failure,
                                            localization))
                              ],
                              if (landingPageState
