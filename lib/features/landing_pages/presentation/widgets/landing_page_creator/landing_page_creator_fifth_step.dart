...
import 'package:finanzbegleiter/features/landing_pages/presentation/widgets/landing_page_creator/landing_page_creator_fifth_step_grid.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_modular/flutter_modular.dart';
import 'package:responsive_framework/responsive_framework.dart';

class LandingPageCreatorFifthStep extends StatefulWidget {
  final LandingPage? landingPage;
  final bool buttonsDisabled;
  final bool isLoading;
  final Function(LandingPage) onBack;
  final Function(LandingPage, String) onSaveTapped;
  final Function(LandingPage, PagebuilderAiGeneration)? onAISaveTapped;
  const LandingPageCreatorFifthStep(
      {super.key,
  ...
  @override
  State<LandingPageCreatorFifthStep> createState() =>
      _LandingPageCreatorFifthStepState();
}

class _LandingPageCreatorFifthStepState
    extends State<LandingPageCreatorFifthStep> {
                  ...
                  child: LayoutBuilder(builder: (context, constraints) {
                    ...
                    return Column(children: [
                      ...
                      if (state is GetLandingPageTemplatesLoadingState) ...[
                        ...
                        LandingPageCreatorFifthStepGrid(
