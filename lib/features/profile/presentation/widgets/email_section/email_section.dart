...
import 'package:finanzbegleiter/features/profile/presentation/widgets/email_section/email_section_desktop.dart';
import 'package:finanzbegleiter/features/profile/presentation/widgets/email_section/email_section_expandable_email.dart';
import 'package:finanzbegleiter/features/profile/presentation/widgets/email_section/email_section_expandable_password.dart';
import 'package:finanzbegleiter/features/profile/presentation/widgets/email_section/email_section_mobile.dart';
...
class _EmailSectionState extends State<EmailSection> {
  ...
  void submitPassword() {
    if (formKey.currentState!.validate()) {
      ...
      Modular.get<ProfileCubit>().reauthenticateWithPasswordForEmailUpdate(
  ...
  void submitEmail() {
    if (formKey.currentState!.validate()) {
      validationHasError = false;
      Modular.get<ProfileCubit>().updateEmail(emailTextController.text.trim());
    }
  }
          ...
          listener: (context, state) {
            if (state is ProfileEmailVerifySuccessState) {
              ...
              setButtonToDisabled(false);
                ...
                is ProfileReauthenticateForEmailUpdateSuccessState) {
              visibleField = EmailSectionVisibleTextField.email;
              setButtonToDisabled(false);
                          ...
                          children: [
                            ...
                            if (errorMessage != "" &&
                                ...
                                (state is ProfileEmailUpdateFailureState ||
                                    state
                                        is ProfileEmailUpdateAuthFailureState) &&
                                !validationHasError) ...[
