...
import 'package:finanzbegleiter/features/page_builder/presentation/top_level_components/landing_page_builder_section_controls.dart';
import 'package:finanzbegleiter/features/page_builder/presentation/top_level_components/landing_page_builder_widget_builder.dart';
import 'package:finanzbegleiter/features/page_builder/presentation/top_level_components/pagebuilder_invisible_color_filter.dart';
...
import 'package:finanzbegleiter/features/page_builder/presentation/top_level_components/section_max_width_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return RepaintBoundary(
      child: Center(
        ...
        constraints: BoxConstraints(maxWidth: outerMaxWidth ?? double.infinity),
                                                  ...
                                                  ? PagebuilderReorderableElement<
                                                      ...
                                                      onAddWidget:
                                                          (widgetLibraryData,
                                                              targetWidgetId,
                                                              position) {
                                                        final newWidget = PagebuilderWidgetFactory
                                                            .createDefaultWidget(
                                                                widgetLibraryData
                                                                    .widgetType,
                                                                AppLocalizations
