...
abstract class AppLocalizations {
  ...
  /// Placeholder for the textfield in the collapsible view for the anchor button section name in the pagebuilder anchor button configuration
  ///
  /// In en, this message translates to:
  /// **'Section name'**
