...
class AppModule extends Module {
  ...
  void binds(i) {
    ...
    i
      ...
      ..addLazySingleton(ProfileImageBloc.new)
      ..addLazySingleton(CompanyImageBloc.new)
      ..add(LandingPageImageBloc.new)
      ..addLazySingleton(CompanyObserverCubit.new)
      ..addLazySingleton(CompanyCubit.new)
      ..addLazySingleton(CompanyRequestCubit.new)
