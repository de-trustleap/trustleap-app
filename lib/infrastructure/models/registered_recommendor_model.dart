...
class RegisteredRecommendorModel {
  ...
  factory RegisteredRecommendorModel.fromFirestore(DocumentSnapshot<Map<String, dynamic>> doc) {
  ...
  factory RegisteredRecommendorModel.fromDomain(RegisteredRecommendor recommendor) {
    return RegisteredRecommendorModel(
