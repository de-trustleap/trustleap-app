import 'package:finanzbegleiter/theme/theme.dart';
...
class DesktopAppTheme {
  ...
  static final TextStyle _lightHeadlineLargeText =
      AppTheme.lightHeadlineLargeText.copyWith(fontSize: 20);
  static final TextStyle _lightBodyLargeText =
      AppTheme.lightBodyLargeText.copyWith(fontSize: 18);
  static final TextStyle _lightBodyMediumText =
      AppTheme.lightBodyMediumText.copyWith(fontSize: 16);
  static final TextStyle _lightBodySmallText =
      AppTheme.lightBodySmallText.copyWith(fontSize: 14);
