...
class AuthModule extends Module {
  @override
  void routes(r) {
    r.child(Modular.initialRoute, child: (_) => const SelectionArea(child: BasePage()));
    r.child(RoutePaths.loginPath, child: (_) => const SelectionArea(child: LoginPage()));

    r.child(RoutePaths.registerPath, child: (_) => const SelectionArea(child: RegisterPage()));
    ...
    r.wildcard(child: (_) => const BasePage());
  }
}
