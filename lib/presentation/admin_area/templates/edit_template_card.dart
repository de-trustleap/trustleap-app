...
class EditTemplateCard extends StatefulWidget {
  ...
  @override
  State<EditTemplateCard> createState() => _EditTemplateCardState();
}

class _EditTemplateCardState extends State<EditTemplateCard> {
