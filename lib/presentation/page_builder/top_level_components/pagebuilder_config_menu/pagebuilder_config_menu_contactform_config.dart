...
class PagebuilderConfigMenuContactFormConfig extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (model.elementType == PageBuilderWidgetType.contactForm &&
      ...
      return CollapsibleTile(title: "Name Textfeld", children: [
        PagebuilderConfigMenuTextfieldConfig(
            properties: (model.properties as PageBuilderContactFormProperties)
...
// TODO: Implement Textfield Properties Configuration
