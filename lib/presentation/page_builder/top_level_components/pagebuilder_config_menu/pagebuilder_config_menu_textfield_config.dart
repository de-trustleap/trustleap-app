    ...
    return BlocBuilder<PagebuilderResponsiveBreakpointCubit,
      ...
      builder: (context, currentBreakpoint) {
        ...
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          PagebuilderNumberStepperControl(
              title:
                  localization.pagebuilder_textfield_config_textfield_min_lines,
          ...
          PagebuilderNumberStepperControl(
              title:
                  localization.pagebuilder_textfield_config_textfield_max_lines,
          ...
          PagebuilderSwitchControl(
              title:
                  localization.pagebuilder_textfield_config_textfield_required,
