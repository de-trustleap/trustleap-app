        ...
        return Column(
            ...
            children: [
              PagebuilderNumberStepperControl(
                  title:
                      localization.pagebuilder_textfield_config_textfield_width,
                  initialValue: helper.getValue(props?.width)?.toInt() ?? 0,
                  minValue: 0,
                  maxValue: 1000,
                  ...
                  onSelected: (width) {
                    final updatedWidth =
                        helper.setValue(props?.width, width.toDouble());
                    onChangedLocal(props?.copyWith(width: updatedWidth));
                  }),
              ...
              PagebuilderConfigMenuTextConfig(
                  ...
                  onChanged: (textProperties) {
                    onChangedLocal(
                        props?.copyWith(textProperties: textProperties));
                  },
